...
#define MQTT_HOST "10.0.0.46" //IP adress of mqtt broker
#define MQTT_PORT 1883 //Port of mqtt broker
#define MQTT_CLIENTID "homekey_dev_mqtt" //client-id to connect to mqtt broker
#define MQTT_USERNAME "rednblkx"  //username to connect to mqtt broker
#define MQTT_PASSWORD "BlknRED54@#"  //password to connect to mqtt broker
...
// MQTT Topics
#define MQTT_CUSTOM_STATE_TOPIC "kodeative/homekey_dev/custom_state" // MQTT Topic for publishing custom lock state
#define MQTT_CUSTOM_STATE_CTRL_TOPIC "kodeative/homekey_dev/set_custom_state" // MQTT Control Topic with custom lock state
#define MQTT_AUTH_TOPIC "kodeative/homekey_dev/auth" // MQTT Topic for publishing HomeKey authentication data or RFID UID
#define MQTT_SET_STATE_TOPIC "kodeative/homekey_dev/set_state" // MQTT Control Topic for the HomeKit lock state (current and target)
#define MQTT_SET_TARGET_STATE_TOPIC "kodeative/homekey_dev/set_target_state" // MQTT Control Topic for the HomeKit lock target state
#define MQTT_SET_CURRENT_STATE_TOPIC "kodeative/homekey_dev/set_current_state" // MQTT Control Topic for the HomeKit lock current state
#define MQTT_STATE_TOPIC "kodeative/homekey_dev/state" // MQTT Topic for publishing the HomeKit lock target state
...
#define HS_PIN 26 // GPIO Pin for a Configuration Mode button (more info on https://github.com/HomeSpan/HomeSpan/blob/master/docs/UserGuide.md#device-configuration-mode)
